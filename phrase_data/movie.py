data = {
  'movie' : {
        ...
        'name' : ['Alien', 'Andrew', 'arcbot', 'Ben', 'Benji', 'Celine',
            'Chase', 'Chris', 'Elliot', 'Jett', 'Flannery', 'Ian', 'Jesse',
            'Matt', 'Nico', 'Niko', 'Predator', 'Rob', 'Russell', 'Sarah',
            'Jake', 'Stalin', 'Tyler Perry', '{Username}'],
        ...
        'subtitle' : ['{sub_premade}', '{Name} vs. {Name}', '{Hype_noun}',
            ...
            '{Protag_group_plural} Meet {Famous_person}'],
