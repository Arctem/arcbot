data = {
    'plan' : {
        ...
        'goal' : ['{generic_verb,person_verb} {target_person,target_people}', '{generic_verb,object_verb} {target_object}', 'prove that {target_person} is {secret_identity}'],
        ...
        'item' : ['Bagger 288', 'dildo', 'AOL Free Trial CD', 'mint-condition Beanie Baby', 'quadcopter', "{famous_person,irc_member}'s {body_part}"],
        'items' : ['Bagger 288s', 'dildos', 'AOL Free Trial CDs', 'quadcopters', 'bratwurst', 'MacBooks'],
        'body_part' : ['face', 'chest', 'forehead', 'arms'],

        'execution' : ["we'll need to {instructions}.", "you'd better hope {condition}."],
        'instructions' : ['get some help from {target_person,target_people}', "make sure {target_person} doesn't find out", 'get {target_object} first', 'find out when the {event} starts'], 
        ...
        #NOT USED YET
        'place' : ['Poland', 'Austria', 'Germany', 'Kansas', 'Burrito Time'],
    }
}
