data = {
  'clickbait' : {
        'template' : ['{crazy_event} {emote_stinger}', '{crazy_event}', '{crazy_question} {evidence_stinger}', '{crazy_question}', '{list_of_things}', '{amazing_find}'],
        ...
        'list_of_things' : ['{gen/number} {things} that look like {celebrity}.', '{gen/number} {topic} tips that any {person} should know!'],

        'amazing_find' : ['This {evidence} will show that you\'ve been {actioning} wrong your entire life!'],
        ...
        'person' : ['dad', 'mom', 'grandpa', 'grandfather', 'grandma', 'grandmother', 'politician', 'teenager', 'high schooler', 'pastor', 'rabbi', 'teacher', 'toddler'],
        ...
        'current_celebrity' : ['Jack Black', 'Obama', 'Bill Murray', 'Hannah Montana',
        ...
        'actioning' : ['stealing {things}', 'cooking {things}', 'eating {things}', 'kissing {things}', 'kissing your {relation}', 'talking', 'learning', 'teaching', 'masturbating', 'hugging'],
        ...
        'objects' : ['toasters', 'fire trucks', 'flowers', 'dildos', 'sandwiches'],
        'bad_things' : ['Nazis', 'fascists', 'Communists', 'pedophiles', 'nymphomaniacs'],
        'weird_things' : ['zombies', 'aliens', 'painters', 'Americans'],

        'singular_animal' : ['a {animal}'],
        'animal' : ['tiger', 'gorilla', 'dolphin', 'hippo', 'panda', 'duck'],
        'animals' : ['tigers', 'gorillas', 'dolphins', 'hippos', 'pandas', 'ducks'],
        ...
        'topic' : ['sex', 'cooking', 'driving', 'fashion', 'make-up', 'Dota', 'gaming', 'seduction', 'relationship', 'shopping'],
    }
}