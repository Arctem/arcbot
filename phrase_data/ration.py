data = {
    'ration': {
        ...
        'contents': ['{acc_package}, {entree}, {side}, {dessert}, and {extras}',
                     '{acc}, {entree}, and {dessert}', '{substitute_entree} and {extras}',
                     '{acc_package}, {entree}, and {dessert}', '{substitute_entree}'],
        ...
        'dessert': ['a vanilla cream disk', 'a chocolate cream disk',
