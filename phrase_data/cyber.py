data = {
  'cyber' : {
        ...
        'thing' : ['{adjective} {thing}']*5 + ['{gen/karst}', 'penis', 'vagina', 'face', 'monkey', 'butt', 'tits', 'murrhole', 'potato', 'nipple', 'balls', 'pussy', 'dick', 'crotch area', 'nethers', 'no-no zone', 'special place', 'boobs', 'titties', 'love pillow', 'waifu', 'man-meat', 'yiffstick', 'cherry', 'bazopzop'],
