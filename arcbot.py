...
class ArcBot(IRCBot):
    ...
    def __init__(self):
        ...
        self.help_message = 'Commands: activate sentience, roll <num>d<sides>, markov (deprecated), stats, link, changes, markov2 (deprecated), todo, fate, cyber, dnd, markov3, name, categories, movie. {nick} can also answer questions directed at it and has a few secret features.'
