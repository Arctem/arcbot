...
class ArcBot(IRCBot):
    ...
    def __init__(self):
        ...
        self.greetings = ('Greetings, son of Skyrim!', 'Well, look who decided to finally show up!', 'It\'s {}! Can I have your autograph?', 'Greetings, brave Sir {}. Shall we ride forth to slay the dragon?', 'Rise and shine, {}.', 'Have at ye, foul villain!', 'Aw darn, {}! You cut the ponytail! Sellout...', '{} has joined the game.', 'A wild {} appeared!')
        ...
        self.eight_ball = ('Please ask again.', 'Yes.', 'Verily.', 'Don\'t even think about it.', 'I wouldn\'t do that if I were you.', 'The guard probably won\'t like that.')
        ...
        self.ignore_list = ('haxbot', 'oblivion-guard', 'totaldowner', 'stats', 'stats_', 'sekacpus', 'supcakes', 'zikotterM', 'hugel')
...
#                self.markov_old = {}
    ...
    def commands(self, connection, event):
        ...
        if command[0].lower() == 'help':
        ...
        elif command[0].lower() == 'restart' and 'arctem' in user:
            self.irc.disconnect_all('restarting')
            os.system('python arcbot.py')
        elif ' '.join(command[:]).lower().startswith('i hate you') and 'arctem' in user:
            ...
            if len(command) is 1:
                ...
                if command[1] == 'remove' and 'arctem' in user:
        ...
        elif command[0] == 'clear' and command[1] == 'markov' and 'arctem' in user:
